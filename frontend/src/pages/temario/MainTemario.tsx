  ...
  return (
    <div className='temario-container'>
      ...
      <div className="temario-content">
        <h1>{user.username}</h1>
        <p>Selecciona un tema para ver el contenido:</p>

        <div className="topics-grid">
          {topics.map(topic => (
            <Link 
              key={topic._id} 
              to={`/temario/${topic._id}`}
              className="topics-card"
            >
              <img src='/images/img_temario.png' alt='topic' />
